...
/* --> doOneSecond */
extern xdc_Void doOneSecond(xdc_UArg);
 ...
 */
xdc__META(__ASM__, "@(#)__ASM__ = C:/ayush2_nigam4/repo/trunk/lab2exercise2/lab2exercise2Project/Debug/configPkg/package/cfg/lab2exercise2_p28FP");
...
ti_sysbios_knl_Clock_Object__ ti_sysbios_knl_Clock_Object__table__V[1] = {
    {/* instance#0 */
        ...
        1,  /* active */
        ((xdc_Void(*)(xdc_UArg))((xdc_Fxn)doOneSecond)),  /* fxn */
        ((xdc_UArg)0),  /* arg */
    },
};
...
#endif
#endif
const ti_sysbios_knl_Clock_Handle clock1sec2 = (ti_sysbios_knl_Clock_Handle)((ti_sysbios_knl_Clock_Handle)&ti_sysbios_knl_Clock_Object__table__V[0]);
