  ...
  ;%***********************
    ...
    ;%
	  ...
	  ;% simulink_plotAndGains_P.DiscreteTransferFcn2_DenCoef
	  ...
	  ;% simulink_plotAndGains_P.Ki1_Gain
	  section.data(8).logicalSrcIdx = 15;
	  section.data(8).dtTransOffset = 8;
	
	  ;% simulink_plotAndGains_P.Ki2_Gain
	  section.data(9).logicalSrcIdx = 16;
	  section.data(9).dtTransOffset = 9;
	
	  ;% simulink_plotAndGains_P.DiscreteTransferFcn3_NumCoef
	  section.data(10).logicalSrcIdx = 17;
	  section.data(10).dtTransOffset = 10;
	
	  ;% simulink_plotAndGains_P.DiscreteTransferFcn3_DenCoef
	  ...
	  ;% simulink_plotAndGains_P.DiscreteTransferFcn_NumCoef
	  section.data(15).logicalSrcIdx = 22;
	  section.data(15).dtTransOffset = 17;
	
	  ;% simulink_plotAndGains_P.DiscreteTransferFcn_DenCoef
	  ...
	  ;% simulink_plotAndGains_P.DiscreteTransferFcn1_DenCoef
  ...
  ;%*******************
    ...
    ;%
	  ...
	  ;% simulink_plotAndGains_DW.Scope_PWORK.LoggedData
	  section.data(6).logicalSrcIdx = 12;
	  section.data(6).dtTransOffset = 5;
	
	  ;% simulink_plotAndGains_DW.Tau_PWORK.LoggedData
	  section.data(7).logicalSrcIdx = 13;
	  section.data(7).dtTransOffset = 8;
	
	  ;% simulink_plotAndGains_DW.Vel_PWORK.LoggedData
  ...
  targMap.checksum0 = 2453460796;
  targMap.checksum1 = 2152053025;
  targMap.checksum2 = 979795426;
  targMap.checksum3 = 2560813684;
