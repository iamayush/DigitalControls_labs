...
void simulink5ms_plotAndGains_output(void)
{
  ...
  simulink5ms_plotAndGains_B.Gain3 = simulink5ms_plotAndGains_P.Gain3_Gain *
    (real_T)simulink5ms_plotAndGains_B.PacketInput1_o2[0];
...
RT_MODEL_simulink5ms_plotAndGains_T *simulink5ms_plotAndGains(void)
{
  ...
  rtmSetTFinal(simulink5ms_plotAndGains_M, 25.0);
  simulink5ms_plotAndGains_M->Timing.stepSize0 = 0.005;

  /* External mode info */
  simulink5ms_plotAndGains_M->Sizes.checksums[0] = (2191052288U);
  simulink5ms_plotAndGains_M->Sizes.checksums[1] = (1155279872U);
  simulink5ms_plotAndGains_M->Sizes.checksums[2] = (1694035117U);
  simulink5ms_plotAndGains_M->Sizes.checksums[3] = (2974204252U);
