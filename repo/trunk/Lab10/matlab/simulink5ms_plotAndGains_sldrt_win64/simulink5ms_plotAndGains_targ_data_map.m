  ...
  ;%*******************
    ...
    ;%
	  ...
	  ;% simulink5ms_plotAndGains_DW.u6bit_Int1_PWORK.LoggedData
	  section.data(2).logicalSrcIdx = 1;
	  section.data(2).dtTransOffset = 1;
	
	  ;% simulink5ms_plotAndGains_DW.u6bit_Int2_PWORK.LoggedData
	  section.data(3).logicalSrcIdx = 2;
	  section.data(3).dtTransOffset = 2;
  ...
  targMap.checksum0 = 2191052288;
  targMap.checksum1 = 1155279872;
  targMap.checksum2 = 1694035117;
  targMap.checksum3 = 2974204252;
