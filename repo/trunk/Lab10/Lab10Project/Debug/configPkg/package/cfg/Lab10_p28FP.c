...
/* --> mainclkfunc */
extern xdc_Void mainclkfunc(xdc_UArg);
...
const __T1_xdc_runtime_Text_charTab xdc_runtime_Text_charTab__A[5985];
 ...
 */
xdc__META(__ASM__, "@(#)__ASM__ = C:/ayush2_nigam4/repo/trunk/Lab10/Lab10Project/Debug/configPkg/package/cfg/Lab10_p28FP");
...
ti_sysbios_knl_Clock_Object__ ti_sysbios_knl_Clock_Object__table__V[1] = {
    {/* instance#0 */
        ...
        1,  /* active */
        ((xdc_Void(*)(xdc_UArg))((xdc_Fxn)mainclkfunc)),  /* fxn */
        ((xdc_UArg)0),  /* arg */
    },
};
...
__FAR__ const CT__xdc_runtime_Text_charCnt xdc_runtime_Text_charCnt__C = (xdc_Int16)0x1761;
