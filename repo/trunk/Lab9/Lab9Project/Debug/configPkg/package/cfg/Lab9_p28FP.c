...
/* --> myclockfunc */
extern xdc_Void myclockfunc(xdc_UArg);
...
const __T1_xdc_runtime_Text_charTab xdc_runtime_Text_charTab__A[5990];
 ...
 */
xdc__META(__ASM__, "@(#)__ASM__ = C:/ayush2_nigam4/repo/trunk/Lab9/Lab9Project/Debug/configPkg/package/cfg/Lab9_p28FP");
...
ti_sysbios_knl_Clock_Object__ ti_sysbios_knl_Clock_Object__table__V[1] = {
    {/* instance#0 */
        ...
        1,  /* active */
        ((xdc_Void(*)(xdc_UArg))((xdc_Fxn)myclockfunc)),  /* fxn */
        ((xdc_UArg)0),  /* arg */
    },
};
...
__FAR__ const CT__xdc_runtime_Text_charCnt xdc_runtime_Text_charCnt__C = (xdc_Int16)0x1766;
