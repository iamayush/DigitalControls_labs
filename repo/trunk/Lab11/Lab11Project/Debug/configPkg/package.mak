...
.dlls,28FP .dlls: Lab11.p28FP

-include package/cfg/Lab11_p28FP.mak
-include package/cfg/Lab11_p28FP.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/Lab11_p28FP.dep
endif
Lab11.p28FP: package/cfg/Lab11_p28FP.xdl
	@


ifeq (,$(wildcard .libraries,28FP))
Lab11.p28FP package/cfg/Lab11_p28FP.c: .libraries,28FP
endif

package/cfg/Lab11_p28FP.c package/cfg/Lab11_p28FP.h package/cfg/Lab11_p28FP.xdl: override _PROG_NAME := Lab11.x28FP
package/cfg/Lab11_p28FP.c: package/cfg/Lab11_p28FP.cfg
package/cfg/Lab11_p28FP.xdc.inc: package/cfg/Lab11_p28FP.xdl
package/cfg/Lab11_p28FP.xdl package/cfg/Lab11_p28FP.c: .interfaces

clean:: clean,28FP
	-$(RM) package/cfg/Lab11_p28FP.cfg
	-$(RM) package/cfg/Lab11_p28FP.dep
	-$(RM) package/cfg/Lab11_p28FP.c
	-$(RM) package/cfg/Lab11_p28FP.xdc.inc

clean,28FP::
	-$(RM) Lab11.p28FP
.executables,28FP .executables: Lab11.x28FP

Lab11.x28FP: |Lab11.p28FP

-include package/cfg/Lab11.x28FP.mak
Lab11.x28FP: package/cfg/Lab11_p28FP.o28FP 
	$(RM) $@
	@$(MSG) lnk28FP $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.C28_float.rootDir)/bin/cl2000 -q -u _c_int00 -z  -o $@ package/cfg/Lab11_p28FP.o28FP   package/cfg/Lab11_p28FP.xdl  -w -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.C28_float.rootDir)/lib/libc.a
	
Lab11.x28FP: export C_DIR=
Lab11.x28FP: PATH:=$(ti.targets.C28_float.rootDir)/bin/;$(PATH)
Lab11.x28FP: Path:=$(ti.targets.C28_float.rootDir)/bin/;$(PATH)

Lab11.test test,28FP test: Lab11.x28FP.test

Lab11.x28FP.test:: Lab11.x28FP
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 Lab11.x28FP.test
else
	@$(MSG) running $<  ...
	$(call EXEC.Lab11.x28FP, ) 
endif

clean,28FP::
	-$(RM) $(wildcard .tmp,Lab11.x28FP,*)
...
%,copy:
	...
	$(RM) $@
	$(CP) $< $@
Lab11_p28FP.o28FP,copy : package/cfg/Lab11_p28FP.o28FP
Lab11_p28FP.s28FP,copy : package/cfg/Lab11_p28FP.s28FP
