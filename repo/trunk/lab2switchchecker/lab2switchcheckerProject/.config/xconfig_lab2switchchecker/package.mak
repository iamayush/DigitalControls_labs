...
override PKGDIR = xconfig_lab2switchchecker
...
package/%.xdc.inc package/%_xconfig_lab2switchchecker.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package xconfig_lab2switchchecker" (because $@ is older than $(firstword $?))" ...
	$(XSRUN) -f xdc/services/intern/cmd/build.xs $(MK_IDLOPTS) -m package/package.xdc.dep -i package/package.xdc.inc package.xdc

.dlls,28FP .dlls: lab2switchchecker.p28FP

-include package/cfg/lab2switchchecker_p28FP.mak
-include package/cfg/lab2switchchecker_p28FP.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/lab2switchchecker_p28FP.dep
endif
lab2switchchecker.p28FP: package/cfg/lab2switchchecker_p28FP.xdl
	@


ifeq (,$(wildcard .libraries,28FP))
lab2switchchecker.p28FP package/cfg/lab2switchchecker_p28FP.c: .libraries,28FP
endif

package/cfg/lab2switchchecker_p28FP.c package/cfg/lab2switchchecker_p28FP.h package/cfg/lab2switchchecker_p28FP.xdl: override _PROG_NAME := lab2switchchecker.x28FP
package/cfg/lab2switchchecker_p28FP.c: package/cfg/lab2switchchecker_p28FP.cfg
package/cfg/lab2switchchecker_p28FP.xdc.inc: package/cfg/lab2switchchecker_p28FP.xdl
package/cfg/lab2switchchecker_p28FP.xdl package/cfg/lab2switchchecker_p28FP.c: .interfaces

clean:: clean,28FP
	-$(RM) package/cfg/lab2switchchecker_p28FP.cfg
	-$(RM) package/cfg/lab2switchchecker_p28FP.dep
	-$(RM) package/cfg/lab2switchchecker_p28FP.c
	-$(RM) package/cfg/lab2switchchecker_p28FP.xdc.inc

clean,28FP::
	-$(RM) lab2switchchecker.p28FP
.executables,28FP .executables: lab2switchchecker.x28FP

lab2switchchecker.x28FP: |lab2switchchecker.p28FP

-include package/cfg/lab2switchchecker.x28FP.mak
lab2switchchecker.x28FP: package/cfg/lab2switchchecker_p28FP.o28FP 
	$(RM) $@
	@$(MSG) lnk28FP $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.C28_float.rootDir)/bin/cl2000 -q -u _c_int00 -z  -o $@ package/cfg/lab2switchchecker_p28FP.o28FP   package/cfg/lab2switchchecker_p28FP.xdl  -w -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.C28_float.rootDir)/lib/libc.a
	
lab2switchchecker.x28FP: export C_DIR=
lab2switchchecker.x28FP: PATH:=$(ti.targets.C28_float.rootDir)/bin/;$(PATH)
lab2switchchecker.x28FP: Path:=$(ti.targets.C28_float.rootDir)/bin/;$(PATH)

lab2switchchecker.test test,28FP test: lab2switchchecker.x28FP.test

lab2switchchecker.x28FP.test:: lab2switchchecker.x28FP
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 lab2switchchecker.x28FP.test
else
	@$(MSG) running $<  ...
	$(call EXEC.lab2switchchecker.x28FP, ) 
endif

clean,28FP::
	-$(RM) $(wildcard .tmp,lab2switchchecker.x28FP,*)


clean:: clean,28FP

clean,28FP::
	-$(RM) lab2switchchecker.x28FP
%,copy:
	@$(if $<,,$(MSG) don\'t know how to build $*; exit 1)
	@$(MSG) cp $< $@
	$(RM) $@
	$(CP) $< $@
lab2switchchecker_p28FP.o28FP,copy : package/cfg/lab2switchchecker_p28FP.o28FP
lab2switchchecker_p28FP.s28FP,copy : package/cfg/lab2switchchecker_p28FP.s28FP

$(XDCCFGDIR)%.c $(XDCCFGDIR)%.h $(XDCCFGDIR)%.xdl: $(XDCCFGDIR)%.cfg $(XDCROOT)/packages/xdc/cfg/Main.xs | .interfaces
	@$(MSG) "configuring $(_PROG_NAME) from $< ..."
	$(CONFIG) $(_PROG_XSOPTS) xdc.cfg $(_PROG_NAME) $(XDCCFGDIR)$*.cfg $(XDCCFGDIR)$*

.PHONY: release,xconfig_lab2switchchecker
ifeq (,$(MK_NOGENDEPS))
-include package/rel/xconfig_lab2switchchecker.tar.dep
endif
package/rel/xconfig_lab2switchchecker/xconfig_lab2switchchecker/package/package.rel.xml: package/package.bld.xml
package/rel/xconfig_lab2switchchecker/xconfig_lab2switchchecker/package/package.rel.xml: package/build.cfg
package/rel/xconfig_lab2switchchecker/xconfig_lab2switchchecker/package/package.rel.xml: package/package.xdc.inc
package/rel/xconfig_lab2switchchecker/xconfig_lab2switchchecker/package/package.rel.xml: .force
	@$(MSG) generating external release references $@ ...
	$(XS) $(JSENV) -f $(XDCROOT)/packages/xdc/bld/rel.js $(MK_RELOPTS) . $@

xconfig_lab2switchchecker.tar: package/rel/xconfig_lab2switchchecker.xdc.inc package/rel/xconfig_lab2switchchecker/xconfig_lab2switchchecker/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELTAR,package/rel/xconfig_lab2switchchecker.xdc.inc,package/rel/xconfig_lab2switchchecker.tar.dep)


release release,xconfig_lab2switchchecker: all xconfig_lab2switchchecker.tar
clean:: .clean
	-$(RM) xconfig_lab2switchchecker.tar
	-$(RM) package/rel/xconfig_lab2switchchecker.xdc.inc
	-$(RM) package/rel/xconfig_lab2switchchecker.tar.dep
