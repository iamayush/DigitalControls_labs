...
/* --> clockfunc */
extern xdc_Void clockfunc(xdc_UArg);
...
const __T1_xdc_runtime_Text_charTab xdc_runtime_Text_charTab__A[5986];
 ...
 */
xdc__META(__ASM__, "@(#)__ASM__ = C:/ayush2_nigam4/repo/trunk/Lab6/Lab6Project/Debug/configPkg/package/cfg/Lab6_p28FP");
...
ti_sysbios_knl_Clock_Object__ ti_sysbios_knl_Clock_Object__table__V[1] = {
    {/* instance#0 */
        ...
        (xdc_UInt32)0xbb8,  /* timeout */
        (xdc_UInt32)0xbb8,  /* currTimeout */
        (xdc_UInt32)0xf,  /* period */
        1,  /* active */
        ((xdc_Void(*)(xdc_UArg))((xdc_Fxn)clockfunc)),  /* fxn */
        ((xdc_UArg)0),  /* arg */
    },
};
...
__FAR__ const CT__xdc_runtime_Text_charCnt xdc_runtime_Text_charCnt__C = (xdc_Int16)0x1762;
...
#endif
#endif
const ti_sysbios_knl_Clock_Handle clock_lab6 = (ti_sysbios_knl_Clock_Handle)((ti_sysbios_knl_Clock_Handle)&ti_sysbios_knl_Clock_Object__table__V[0]);
