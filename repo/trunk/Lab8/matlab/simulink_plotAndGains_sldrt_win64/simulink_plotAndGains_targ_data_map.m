  ...
  ;%***********************
    ...
    ;%
	  ...
	  ;% simulink_plotAndGains_P.Posn_Gain
	  section.data(2).logicalSrcIdx = 9;
	  section.data(2).dtTransOffset = 1;
	
	  ;% simulink_plotAndGains_P.U_Gain
	  section.data(3).logicalSrcIdx = 10;
	  section.data(3).dtTransOffset = 2;
	
	  ;% simulink_plotAndGains_P.Ref_Gain
  ...
  ;%**************************
    ...
    ;%
	  ...
	  ;% simulink_plotAndGains_B.Posn
	  section.data(2).logicalSrcIdx = 1;
	  section.data(2).dtTransOffset = 1;
	
	  ;% simulink_plotAndGains_B.U
	  section.data(3).logicalSrcIdx = 2;
	  section.data(3).dtTransOffset = 2;
	
	  ;% simulink_plotAndGains_B.Ref
  ...
  ;%*******************
    ...
    ;%
	  ...
	  ;% simulink_plotAndGains_DW.ref_PWORK.LoggedData
	  section.data(4).logicalSrcIdx = 3;
	  section.data(4).dtTransOffset = 5;
	
	  ;% simulink_plotAndGains_DW.u_PWORK.LoggedData
  ...
  targMap.checksum0 = 1116753401;
  targMap.checksum1 = 1397365430;
  targMap.checksum2 = 375019130;
  targMap.checksum3 = 2949141154;
