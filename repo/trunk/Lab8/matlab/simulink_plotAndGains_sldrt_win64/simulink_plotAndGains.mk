...
MAKECMD         = "C:/MATLAB~2/bin/win64/gmake"
HOST            = ANY
BUILD           = yes
...
MODEL                := simulink_plotAndGains
MODULES              := rtGetInf.c rtGetNaN.c rt_nonfinite.c simulink_plotAndGains_data.c simulink_plotAndGains_tgtconn.c
MAKEFILE             := simulink_plotAndGains.mk
MATLAB_ROOT          := C:/MATLAB~2
MATLAB_BIN           := C:/MATLAB~2/bin
S_FUNCTIONS          := 
S_FUNCTIONS_LIB      := 
SOLVER               := 
NUMST                := 1
...
SHARED_LIB           := 
TARGET_LANG_EXT      := c
OPTIMIZATION_FLAGS   := -O4 -O4 -O4 -O4 -O4 -O4 -O4 -O4 -O4 -O4 -O4
ADDITIONAL_LDFLAGS   := 
DEFINES_CUSTOM       := 

# Simulink Desktop Real-Time specific parameters
SLDRTDIR             := C:/MATLAB~2/toolbox/sldrt
TARGETARCH           := win64
CC_LISTING           := 0
REBUILD_ALL          := 0
...
#
MODELLIB                  := simulink_plotAndGainslib_sldrt.lib
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := simulink_plotAndGains_ref.rsp
MODELREF_INC_PATH         := 
...
# additional includes
REQ_INCLUDES += ;C:/ayush2_nigam4/repo/trunk/Lab8/matlab;C:/ayush2_nigam4/repo/trunk/Lab8/matlab/simulink_plotAndGains_sldrt_win64;$(MATLAB_ROOT)/rtw/c/src/ext_mode/common
