...
/* --> mainclock */
extern xdc_Void mainclock(xdc_UArg);
 ...
 */
xdc__META(__ASM__, "@(#)__ASM__ = C:/ayush2_nigam4/repo/trunk/Lab8/Lab8Project/Debug/configPkg/package/cfg/Lab8_p28FP");
...
ti_sysbios_knl_Clock_Object__ ti_sysbios_knl_Clock_Object__table__V[1] = {
    {/* instance#0 */
        ...
        1,  /* active */
        ((xdc_Void(*)(xdc_UArg))((xdc_Fxn)mainclock)),  /* fxn */
        ((xdc_UArg)0),  /* arg */
    },
};
